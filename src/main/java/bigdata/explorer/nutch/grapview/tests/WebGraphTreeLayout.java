 ...
 * 
 */
package bigdata.explorer.nutch.grapview.tests;

import bigdata.explorer.nutch.NutchGraphLoader;
...
public class WebGraphTreeLayout extends JApplet {
    ...
    RadialTreeLayout<String,Number> radialLayout;
    ...
    private void createTree() throws IOException {
        ...
        String path = "/home/kamir/ANALYSIS/Nutch/YellowMED_CORE"; 

        // NutchGraphLoader.loadTreeGraph(path,graph);
