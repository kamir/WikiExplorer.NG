...
public class MyNetworkStreamMode {
    ...
    public void nextCN() { 
     ...
     public void addLink( MyLink2 link , int _k) throws IOException { 
        link.k = _k;
    ...
    public void init(String netn, String aspekt ) throws IOException {
        
        String cleanName = FileNameFilter.cleanWikinameForFilename( netn );

            
            File folder = TSB.getAspectFolder( aspekt , studie );

            File f = new File( folder.getAbsolutePath() + "/" + netn );
    ...
    public void init(String netn) throws IOException {
        ...
        String cleanName = FileNameFilter.cleanWikinameForFilename( netn );
            ...
            File folder = TSB.getAspectFolder( "pagelink.network" , studie);
    ...
    public void createNodeIDListe() throws IOException {
        ...
        File folder = TSB.getAspectFolder( "node.ids.dict" , studie);
        ...
        File f = new File( folder + "/" + studie + ".ids.dict" );
    ...
    public void createWikiIDListe() throws IOException {
        ...
        File folder = TSB.getAspectFolder( "lang.ids.dict" , studie);
        ...
        File f2 = new File( folder + "/" + studie + ".wikis.dict" );
        int i2 = 0;
