...
import static m3.wikipedia.explorer.WikiHistoryExplorer.loadPageHistory;
...
public class CoreDensiteyCalculator {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, FailedLoginException, Exception {
        ...
        BufferedWriter br = new BufferedWriter( new FileWriter( new File( "/Volumes/MyExternalDrive/CALCULATIONS/data/out/core_density_PLOSONE_paper_v09.dat" )));
        int i = 0;
        for (String pn : pages) {
    ...
    public static void loadCoreDensity(String wikipedia, String pn, BufferedWriter fw ) throws IOException, Exception {
        ...
        int n = map.size() + 1 ;  // wegen der CN, die ja auch zum core gehört !!!
        double z = n * (n-1);
        double rho = SUMIWL / z;
