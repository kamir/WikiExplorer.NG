 ...
 * @author kamir
 */
public class DistributionCheckChartsDetailedV5 {

//    static ExcelProject pro = new ExcelProject("test_excel_influence_of_tau");
    static ExcelProject pro = new ExcelProject("test_excel_influence_of_tau_v5");
...
//        mainLoop( "R11" , "SP500" );        
    ...
    public static void mainLoop( String run, String inputset ) throws FileNotFoundException, IOException { 
        ...
        chartsVII = new Hashtable<String,Vector<Messreihe>>();
        v1 = new Vector<Messreihe>();
        v2 = new Vector<Messreihe>();
        v3 = new Vector<Messreihe>();
        chartsVII.put( "tv",  v1 );
...
//        doWorkNow(fnBASE, inputset, storSignificanz);
        ...
        pro.storeNow("Report_v5_" + run + "_" + inputset);
    }
    ...
    static Hashtable<String,Vector<Messreihe>> chartsVII = null;
...
//        }
    ...
    public static void prozessHistoGR( String type, boolean shuffled ) { 
             ...
             Vector<Messreihe> mr = chartsVII.get( type );
             Messreihe r = null;
