package m3.wikipedia.corpus.extractor.category;
...
public class ExtractCategorieCorpus {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, FailedLoginException, Exception {
        ...
        extractCorpus(wiki, page, "TEST.ExtractCategorieCorpus" );
        
    }
    
    public static void extractCorpus( String wiki, String page, String st) throws IOException {
        
        Corpus corpus = new Corpus( st );
