...
public class MyLensDemo extends JApplet {
    ...
    /** Datencontainer zum erzeugen des Graphen **/
    CCResults r = null;
    double level = 0.0;
    public MyLensDemo( CCResults _r , double _level) {
        super();
        r = _r;
        level = _level;
        init();
     ...
     * TemporalNetworkOfWikipediaNodes
     */
    public MyLensDemo() {
        init();
    }
    ...
    public void init() {
        ...
        try {
            ...
            Logger.getLogger(MyLensDemo.class.getName()).log(
...
//        }
    ...
    public static void main(String[] args) {
        ...
        f.getContentPane().add(new MyLensDemo());
        f.pack();
        f.setVisible(true);
    }
}
