 ...
 */
package bigdata.explorer.nutch.grapview;
...
public class ShowLayouts extends JApplet {
    ...
    protected static String[] graph_names = {"Two component graph", 
        ...
        "Chain+isolate graph", "Trivial (disconnected) graph", "GORBO"};
...
//				if(layout instanceof IterativeContext) {
    ...
    public void start()
    {
        try {
            ...
            Logger.getLogger(ShowLayouts.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
