...
import com.cloudera.wikiexplorer.ng.util.TimeLog;
    ...
    public class RedirectCreationAndDestructionDetector {

        static DB db = null;
        static Connection con = null;
        static Statement st  = null;

        static public String pfad = "E:/";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println( "Full list of redirects ... " );

        File f1 = new File( pfad + "all_redirects_creation.dat" );
        File f2 = new File( pfad + "all_redirects_destruction.dat" );
    ...
    static public void extractCreationData( BufferedWriter br ) {
        String stmt1 = "SELECT * From redirects,revisions WHERE RevisionIDStart=RevisionID" ;
...
//        t.start();
    ...
    static public void extractDestructionData( BufferedWriter br ) {
        String stmt1 = "SELECT * From redirects,revisions WHERE RevisionIDEnd=RevisionID" ;
        extractData( br, stmt1 );
...
//        t.start();
    ...
    static public void extractData( BufferedWriter br, String stmt ) {
        ...
        try {
            ...
            tl.setStamp("[Start] ... full list of redirects ..." );
